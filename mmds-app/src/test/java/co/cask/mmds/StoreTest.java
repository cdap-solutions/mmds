...
public class StoreTest extends TestBaseWithSpark2 {
  ...
  public void testExperimentsTable() throws Exception {
    ...
    Experiment experiment2 = new Experiment(experiment2Name, "d", "s", "o", "string");
  ...
  public void testModelsTable() throws Exception {
    Experiment experiment1 = new Experiment("e1", "", "path", "o1", "string");
    Experiment experiment2 = new Experiment("e2", "", "path", "o1", "string");
  ...
  public void testExperimentsSorting() throws Exception {
    ...
    Experiment experiment3 = new Experiment(experiment3Name, "d", "s", "o", "string");
    experimentsTable.put(experiment3);

    String experiment4Name = "zsd345";
    Experiment experiment4 = new Experiment(experiment4Name, "d", "s", "o", "string");
    experimentsTable.put(experiment4);

    String experiment5Name = "yea345";
    Experiment experiment5 = new Experiment(experiment5Name, "d", "s", "o", "string");
  ...
  public void testModelLifecycle() throws Exception {
    ...
    Experiment experiment = new Experiment("re", "desc", "srcpath", "outcome", "string");
