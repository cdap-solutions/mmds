...
public class TreeParams implements ModelerParams {
  ...
  public TreeParams(Map<String, String> modelParams) {
    ...
    this.minInstancesPerNode = new IntParam("minInstancesPerNode",
    ...
    this.minInfoGain = new DoubleParam("minInfoGain",
